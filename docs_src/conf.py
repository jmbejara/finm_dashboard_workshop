...
# Needed for Sphinx extensions that import local modules
...
html_theme_options = {
    ...
    "repository_url": "https://github.com/jbejarano/finm_dashboard_workshop",
...
html_title = "From Data to Dashboard"
